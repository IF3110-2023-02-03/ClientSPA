...
function Followers() {
    ...
    function changeRequest() {
        if (isRequestPage) {
            document.getElementById('see-request-btn').innerText = "See Request"
        } else {
            document.getElementById('see-request-btn').innerText = "All Followers"
        }
        ...
        <Box 
            ...
            <Flex
                ...
                <Flex
                    ...
                    gap={"20px"}
                    alignItems={"center"}>
                    <Button p={"0 40px"} id="see-request-btn" onClick={changeRequest}>See Request</Button>
