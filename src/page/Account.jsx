        ...
        <Box 
            ...
            <Flex
                ...
                <Flex
                    ...
                    gap={"20px"}
                    alignItems={"center"}>
                    <Button p={"0 40px"} id="see-request-btn">Logout</Button>
                </Flex>
            </Flex>
            <Card 
                flex 
                    ...
                    <Flex
                        ...
                        <Box
                            ...
                            <Flex 
                                ...
                                <Popover>
                                    ...
                                    <PopoverContent w={"-moz-fit-content"}>
                                        <PopoverArrow />
                                        <Button onClick={onOpen1}>Edit Description</Button>
                                        ...
                                        <Button onClick={onOpen2}>Change Profile Picture</Button>
                                        ...
                                        <Button onClick={onOpen3}>Change Username</Button>
                                        ...
                                        <Button onClick={onOpen4}>Change Name</Button>
                            ...
                            <Flex
                                ...
                                <Text fontSize={"24px"}>@natthankrish</Text>
                                <br></br>
                                <Text
                                ...
                                <Flex
                                    ...
                                    <Flex 
                                        ...
                                        <Image 
                                            ...
                                            h={"20px"}
                                            w={"20px"}/>
                                        <Text>12 Exclusive Content</Text>
                                        <Image 
